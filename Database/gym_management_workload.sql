...
CREATE TABLE `workload` (
  `id_workload` int NOT NULL,
  `id_employee` int NOT NULL,
  `day` varchar(50) DEFAULT NULL,
  `time_to_begin` time DEFAULT NULL,
  `time_to_end` time DEFAULT NULL,
  PRIMARY KEY (`id_workload`),
  KEY `fk_employee` (`id_employee`),
  CONSTRAINT `fk_employee` FOREIGN KEY (`id_employee`) REFERENCES `employee` (`id_employee`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2024-05-20 20:10:13
