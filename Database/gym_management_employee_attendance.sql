...
CREATE TABLE `employee_attendance` (
  ...
  KEY `fk_id` (`id_employee`),
  CONSTRAINT `fk_id` FOREIGN KEY (`id_employee`) REFERENCES `employee` (`id_employee`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2024-05-20 20:10:11
