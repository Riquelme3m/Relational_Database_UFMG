...
CREATE TABLE `bought` (
  ...
  `paid_vlue` decimal(10,2) DEFAULT NULL,
  KEY `fk_eqpq` (`id_equip`),
  CONSTRAINT `fk_eqpq` FOREIGN KEY (`id_equip`) REFERENCES `equipment` (`id_equip`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-05-20 20:10:36
