...
CREATE TABLE `payment` (
  ...
  KEY `fk_subscriber` (`id_subscriber`),
  CONSTRAINT `fk_subscriber` FOREIGN KEY (`id_subscriber`) REFERENCES `subscriber` (`id_subscriber`) ON DELETE RESTRICT ON UPDATE CASCADE
...
-- Dump completed on 2024-05-20 20:10:20
