...
CREATE TABLE `cleaner` (
  ...
  KEY `fk_emppldp` (`id_employee`),
  CONSTRAINT `fk_emppldp` FOREIGN KEY (`id_employee`) REFERENCES `employee` (`id_employee`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2024-05-20 20:10:31
